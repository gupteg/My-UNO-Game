...
function handleEndOfRound(winners) {
    if (!gameState || gameState.phase === 'RoundOver' || gameState.phase === 'GameOver') return;
...
io.on('connection', (socket) => {
  ...
  socket.on('choosePlayDrawnWild', ({ play, cardIndex }) => {
      ...
      if (!player || playerIndex !== gameState.currentPlayerIndex) return; // Added !player check
